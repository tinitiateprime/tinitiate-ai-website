    ...
    <main className="bg-white text-gray-900">
      ...
      <section className="px-6 py-10">
        ...
        <div className="mx-auto max-w-7xl space-y-5 text-gray-700 mt-10">
          <p>
            At <span className="font-semibold text-gray-900">Tinitiate AI</span>, corporate training is a core offering.
          ...
          <p>
            Backed by <span className="font-semibold text-gray-900">3+ years</span> of focused delivery at Tinitiate AI,
      ...
      <section className="px-6 pb-10 md:pb-12">
        <div className="mx-auto max-w-7xl space-y-5 text-gray-700">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
            Empower Your Team with Tinitiate AI
          </h2>
          <p>
            At <span className="font-semibold text-gray-900">Tinitiate AI</span>, we bring together experienced trainers
      ...
      <section className="px-6 pb-12 md:pb-14">
        <div className="mx-auto max-w-7xl space-y-5 text-gray-700">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
            Discover the Tinitiate AI Advantage
          </h2>
          <p>
...
<section className="px-6 py-10 bg-white">
  <div className="mx-auto max-w-7xl space-y-6 text-gray-700">
    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 text-center">
      Discover the Transformative Potential of Tinitiate AI Training
    </h2>
...
<section className="px-6 mt-4 pb-10">
  <div className="mx-auto max-w-7xl space-y-6 text-gray-700">
    ...
    <p className="text-base md:text-lg leading-relaxed text-center max-w-6xl mx-auto">
      ...
      <span className="font-semibold text-gray-900"> Tinitiate AI</span>, we provide a structured and supportive
