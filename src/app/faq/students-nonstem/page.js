...
export const metadata = {
  title: "Student FAQ — Non-STEM (No Coding Background Needed) | TINITIATE AI",
  description:
    "For students from non-STEM backgrounds: why tech skills matter in every career, what you’ll learn at TINITIATE AI, and how projects + mentoring make you job-ready.",
  openGraph: {
        ...
        <div className="relative overflow-hidden rounded-3xl border border-gray-200 bg-gradient-to-br from-sky-50 to-white p-7 md:p-10 shadow-sm">
          ...
          <div className="relative">
            ...
            <p className="mt-3 max-w-2xl text-sm text-gray-600 md:text-base">
              Why tech skills matter in every career and how TINITIATE AI helps you learn
