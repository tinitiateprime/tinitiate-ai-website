...
export const metadata = {
  title: "Why TINITIATE AI — Remote Training that Fits Your Life",
  description:
    "Why remote training, what makes TINITIATE AI different, course duration, best technologies in India, flexibility, certificates, and job-readiness.",
  openGraph: {
    title: "Why TINITIATE AI — Remote Training that Fits Your Life",
    description:
      ...
      <section className="mx-auto w-[92%] max-w-[1200px] pb-6">
        <div className="rounded-3xl border border-gray-200 bg-gradient-to-br from-sky-50 to-white p-7 md:p-10">
          ...
          <h1 className="mt-2 text-2xl font-extrabold leading-tight md:text-4xl">
            Why TINITIATE AI — Remote Training that Fits Your Life
          </h1>
